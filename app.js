...
/* ============================================================
   ...
   ============================================================ */
const Q_ADVICE = {
  q1:  "褒められた時、注意された時のエピソードをより具体的に聞いてみましょう！\n注意されることについて、どんな対策をしていますか？",
  q3:  "その壁をどうやって乗り越えたのですか？",
  q4:  "なんでその順番にしたのですか？",
  q5:  "家族旅行はどんなところに行ったことがありますか？移動中のエピソードを聞いてみましょう！\n将来2人や子どもも含めて家族旅行に行く時は車、公共交通機関どちらをメインに使いたいですか？",
  q6:  "なんでその順番にしたのですか？\nこの中で現在すでに手にしているなと思うものはどれですか？",
  q7:  "それをしたい理由や具体的なプランを聞いてみましょう！",
  q8:  "それをしたい理由や具体的なプランを聞いてみましょう！",
  q10: "なんでそれを選んだのですか？自身の親はこの選択肢の中だとどういうタイプでしたか？",
  q11: "なんでそれを選んだのですか？自身の親はこの選択肢の中だとどういうタイプでしたか？",
};
...
/* ------------------------------------------------------------
   ...
   ------------------------------------------------------------ */
const SHARETARGETPICKER_IMAGE_URL = "https://marriagesketch.github.io/-jikokaiji_qa3-/sharetargetpicker.jpg";
...
function buildShareFlexMessage(shareName, shareURL) {
  ...
  return {
    type: "flex",
    altText: `恋活・婚活 自己開示QA Part3 - ${nameLine}`,
    contents: {
      type: "bubble",
      hero: {
        type: "image",
      ...
      body: {
        ...
        paddingAll: "20px",
        contents: [
          { type: "text", text: "恋活・婚活 自己開示QA Part3", size: "xs", weight: "bold", color: "#d96c7d" },
  ...
  document.getElementById("shareBtn").addEventListener("click", async () => {
    ...
    try {
      ...
      const previewMsg = shareName
        ? `${shareName}さんの恋活・婚活　自己開示QA part3の回答が届きました。\n回答をみる→${shareURL}`
        : `恋活・婚活　自己開示QA part3の回答が届きました。\n回答をみる→${shareURL}`;
